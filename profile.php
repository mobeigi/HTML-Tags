        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if(isset($_GET['error'])) {
                  ...
                  //Print error message
                  print '<div style="background-color: #dff2bf; border: 1px solid #9f6000; padding: 15px 10px;">';
                ...
                <div class="row">
                  ...
                  if(isset($_SESSION['user_id'])) {
                    ...
                    for($i = 0; $i != $row_size; $i++) {
                        ...
                        print "<a style='width:200px; text-align: center;' class='thumbnail' href='view_trip.php?trip=";
